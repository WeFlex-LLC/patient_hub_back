...
const tiket=(body,orderId)=>{
    ...
    @import url(https://fonts.googleapis.com/css?family=Cabin:400,700);
        ...
        @media only screen and (max-width:480px) {
          ...
          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
            <div><span style="font-size: 20px; font-family: 'book antiqua', palatino, serif;">Ticket owner - ${body.name}</span><br><span style="font-size: 20px; font-family: 'book antiqua', palatino, serif;">Order Id - ${orderId}</span><br></div>
          </div>
