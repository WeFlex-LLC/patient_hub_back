    ...
    @import url(https://fonts.googleapis.com/css?family=Cabin:400,700);
        ...
        @media only screen and (max-width:480px) {
          ...
          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
            <div><span style="font-family: 'book antiqua', palatino, serif;"><strong><span style="font-size: 24px;">Dear customer thank you for shopping.</span></strong></span></div>
    <div> </div>
    <div>
    <div><span style="font-size: 18px; font-family: 'book antiqua', palatino, serif;">Yor Order: ${orderId} has been delivered.</span></div>
    <div> </div>
    <div><span style="font-size: 15px; font-family: 'book antiqua', palatino, serif;">Please connect with us if there is any problem with delivery</span></div>
    <div> </div>
    </div>
          </div>
          ...
          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
            <div><strong><span style="font-family: 'book antiqua', palatino, serif; font-size: 24px;">Հարգելի հաճախորդ, շնորհակալություն գնումների համար</span></strong></div>
    <div> </div>
    <div>
    <div><span style="font-size: 18px; font-family: 'book antiqua', palatino, serif;">Ձեր պատվերը (${orderId}) առաքվել է։</span></div>
    <div> </div>
    <div><span style="font-family: 'book antiqua', palatino, serif; font-size: 15px;">Առաքման հետ կապված որևէ խնդիր դեպքում կապվեք մեզ հետ:</span></div>
    </div>
          </div>
